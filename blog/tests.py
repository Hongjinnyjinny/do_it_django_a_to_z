...
class TestView(TestCase):
    def setUp(self):
        ...
        self.user_woosung.is_staff = True
        self.user_woosung.save()
    ...
    def test_post_list(self):
        ...
        self.assertIn(self.user_woosung.username.upper(), main_area.text)
...
# Create your tests here.
    ...
    def test_create_post(self):
        ...
        self.client.login(username='trump', password='1q2w3e4r1')
        response = self.client.get('/blog/create_post/')
        self.assertNotEqual(response.status_code, 200)

        self.client.login(username='woosung', password='1q2w3e4r1')
        response = self.client.get('/blog/create_post/')
        self.assertEqual(response.status_code, 200)
        soup = BeautifulSoup(response.content, 'html.parser')
        ...
        self.assertEqual(last_post.author.username, 'woosung')
    ...
    def test_update_post(self):
        ...
        self.client.login(username=self.user_trump.username, password='1q2w3e4r1')
        response = self.client.get(update_post_url)
        self.assertEqual(response.status_code, 403)

        self.client.login(username=self.post_003.author.username, password='1q2w3e4r1')
        response = self.client.get(update_post_url)
        self.assertEqual(response.status_code, 200)
        soup = BeautifulSoup(response.content, 'html.parser')
